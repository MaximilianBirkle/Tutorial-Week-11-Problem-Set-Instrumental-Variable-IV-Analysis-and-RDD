...
Under this null hypothesis, the relationship between the instrument ($Z_I$) and the outcome ($Y_I$) is solely due to chance and should not change the observed 2SLS estimate $H_0:\beta_2=0$.
